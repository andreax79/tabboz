...
((exports) => {
    ...
    async function messageBox(hWnd, lpText, lpCaption, uType, parentWindowId) {
        ...
        if (uType & 0x00000020) { // MB_ICONQUESTION
            c.querySelector('img').src = "resources/icons/novantotto/102.png";
        } else if (uType & 0x00000010) { // MB_ICONSTOP
            c.querySelector('img').src = "resources/icons/novantotto/103.png";
        } else if (uType & 0x00000030) { // MB_ICONEXCLAMATION
            c.querySelector('img').src = "resources/icons/novantotto/101.png";
        } else if (uType & 0x00000040) { // MB_ICONINFORMATION
            c.querySelector('img').src = "resources/icons/novantotto/104.png";
        }
        // Buttons
