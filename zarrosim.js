...
function __asyncjs__DialogBoxWaitEvent(windowId){ return Asyncify.handleAsync(async () => { return await waitListenerS(`#win${windowId} button, #win${windowId} input, #win${windowId} .menu`, "click"); }); }
